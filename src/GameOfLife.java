 ...
 * Проектирование реакивных интеллектуальныхх агентов. Игра "Жизнь".
 * 
 * Задание: реализовать приложение, которое поледовательно отображает состояние
 * клеточной модели "Игра жизнь". Исследовать возможные конфигурации игры, которые
 * переходят в устойчивое состояние, вымирают, либо возвращаюся в исходное
 * состояние.
 * 
...
public class GameOfLife {
	...
	public static void main (String[] args) {
        ...
        final JButton goButton = new JButton("Пуск");
	...
	private static void processOfLife() {
        for (int x = 0; x < LIFE_SIZE; x++) {
            for (int y = 0; y < LIFE_SIZE; y++) {
                ...
                //Если три клетки рядом живы - клетка рождается
                nextGeneration[x][y] = (count == 3) 
                						? true 
                						: nextGeneration[x][y];
                //Если меньше двух или больше трех рядом живы - клетка умирает
